...
<form id="namesearch" action="/namesearch_student" method="POST">
...
<div class="four columns">
<form id="rollsearch" action="/rollsearch_student" method="POST">
...
<div class="four columns">
<form id="roomsearch" action="/roomsearch_student" method="POST">
      ...
      <input class="u-full-width" type="number" id="sflat" min="0" max="999"  value="0"  name="2"/>
    
    
      <label for="sroom">Room </label>
      <select class="u-full-width" id="sroom" name="3">
      <option value="0">Any</option>
