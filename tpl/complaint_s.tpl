...
<form id="register" action="/complaint" method="POST">
  
  <input class="u-full-width" type="number" id="sroll" max="999999999" name="1" style="display: none;" value="{{rolling}}"/>
  ...
  <input class="button-primary" type="submit" name="search" value="Add complaint">

</form>
</div>

<div class="six columns">
<form id="show_it" action="/complaint" method="POST">

      <select class="u-full-width" id="croll" name="5" style="display: none;" value="1">
        <option value="0" style="display: none;">Any</option>
        <option value="1" style="display: none;">Specific</option>
      </select>
      
  <input class="u-full-width" type="number" value="{{rolling}}" placeholder="123456789" id="ssroll" max="999999999" name="7" style="display: none;"/>
      
      

  <label for="cvname" >Complaint status</label>
